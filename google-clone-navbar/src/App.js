    ...
    <div className="text-center bg-stone-700/80 h-screen w-full">
      <header className="fixed top-0 left-0 w-full z-50">
        <nav className="h-16 w-full ">
          {/*1. div parent*/}
          <div className="flex justify-between items-center h-full w-full bg-stone-600       px-2 ">
        ...
        <div className="bg-stone-700/80 h-10 w-full flex items-center text-gray-300 ">
          ...
          <div className="h-12 w-full flex justify-end gap-12  items-center text-gray-300 capitalize bg-stone-700/80">
...
<main>
  <section className="h-screen flex-col gap-12 w-full flex items-center justify-center  text-white capitalize mx-auto my-10">
   <div className="text-8xl">google</div> 
   <div className="border px-1 bg-white duration-500 active:outline-sky-500 active:outline gap-2 flex items-center my-2 py-2 max-w-[850px] mx-2 w-full rounded-full text-gray-700">
    <div className="flex items-center justify-start px-2 py-3">
      <FaSearch />
    </div>
    <input type="text" name="" id="" className="w-full px-2 outline-none rounded-xl py-2 bg-white" placeholder="search gogle our here you enter a url " />
